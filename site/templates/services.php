...
<?php snippet('header-black') ?>
	...
	<main class="main" id="services">
  	...
  	<div class="blockquote">
		<img src="<?php echo url('/assets/images/asset-blockquote-onlywatch.jpg'); ?>" alt="OnlyWatch" />
		<div>
			<p class="quote">« we enjoy oui will's enthusiasm to discover, <br/> create and actualize ».</p>
			<p class="author">Luc Pettavino / President of Only Watch</p>
		</div>
	</div>
