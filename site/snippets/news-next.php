		...
		<?php if( $prev = $page->prevVisible() && $next = $page->nextVisible() ): ?>
	  	<div class="half prev">
	  		<div class="txt-wrap">
				...
				<h4><span class="arrow prevArrow"></span><a href="<?php echo $page->prev()->url() ?>"><?php echo $page->prev()->title()->excerpt(35) ?></a></h4>
	  		</div>
	  		<div>
	  	...
	  	<div class="half next">
	  		<div class="txt-wrap">
				...
				<h4><span class="arrow nextArrow"></span><a href="<?php echo $page->next()->url() ?>"><?php echo $page->next()->title()->excerpt(35) ?></a></h4>
	  		</div>
	  		<div>
