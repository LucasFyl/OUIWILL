...
var newsTween = new TweenMax.staggerFromTo('#home .single-news', 1, {opacity:0}, {opacity:1,ease:Power4.easeInOut}, 0.2);
...
var workScene = new ScrollMagic.Scene({triggerElement: "#home .news", triggerHook: 'onEnter', offset: 150})
    .addTo(controller)
    .setTween(newsTween);
